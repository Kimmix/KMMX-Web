...
const backgroundContexts = {
    "overview": {
        ...
        What drew him to join wasn't prestige, but access. Nehixim controlled the only stable, concentrated Arcai sample in existence—the key to questions that had driven his entire career. He believed their pitch about advancing humanity through responsible research, thinking he could maintain his scientific integrity within their organization. That illusion didn't last. Nehixim prioritizes weaponization over discovery, and now he's trapped—bound by contract, his reputation tied to them, and that Arcai sample still inaccessible anywhere else. The very thing that drew him in became his cage.`
    },
    "personality": {
        text: `Kimmix doesn't maintain many personal relationships. He finds most social interactions draining and unnecessary. His closest contacts are fellow researchers who communicate through encrypted channels, sharing findings in coded language that appears as routine technical discussion. They form a loose network of scientists across faction lines who prioritize knowledge over politics.

        In public settings, he's detached and often abrasive. It's intentional—a reputation as a difficult person keeps unwanted attention away. This works well until his research requires actual cooperation. Only a few people have seen past the facade to the dry humor and occasional compassion underneath.`
    },
    "objectives": {
        text: `Officially, Kimmix documents naturally occurring Arcai phenomena and reports findings to Nehixim for potential applications. Unofficially, he's pursuing his own goal: understanding whether Arcai energy could address his own flaws. This unauthorized research could mean reassignment or worse if discovered.

        What Nehixim doesn't know is that he's been documenting everything in ways that can be easily leaked to the wider scientific community. While his handlers think findings stay in classified databases, Kimmix operates on a different principle: knowledge belongs to everyone, not just those with power. He's aware this could harm Nehixim's interests, but continues anyway—scientific progress shouldn't be locked behind factional walls. It's also his way of dealing with the guilt of enabling weapons development. Share the knowledge, maybe offset some of the damage. This approach has isolated him further. Neither side fully trusts his intentions.`
    }
};
